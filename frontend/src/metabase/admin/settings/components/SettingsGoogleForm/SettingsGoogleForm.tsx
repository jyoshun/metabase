...
const SettingsGoogleForm = ({
  ...
  return (
    ...
    >
      ...
      <FormCaption>
        {t`Allows users with existing DataMan accounts to login with a Google account that matches their email address in addition to their DataMan username and password.`}
      </FormCaption>
      <FormCaption>
        {jt`To allow users to sign in with Google you'll need to give DataMan a Google Developers console application client ID. It only takes a few steps and instructions on how to create a key can be found ${(
